...
import type { KingenRoundKind, TrumpSelectionMode } from '../games/kingen/types.ts';
...
const nl = {
  ...
  'setup.strictHeartsHint': 'Kun je geen kleur bekennen, dan móót je een harten afgooien als je die hebt.',
  'setup.strictKJLabel': 'Strikt bij “Geen heren en boeren”',
  'setup.strictKJHint': 'Kun je geen kleur bekennen, dan móót je een heer of boer afgooien als je die hebt.',
  'setup.strictQueensLabel': 'Strikt bij “Geen dames”',
  'setup.strictQueensHint': 'Kun je geen kleur bekennen, dan móót je een dame afgooien als je die hebt.',
  'setup.strictKingLabel': 'Strikt bij “De King”',
  'setup.strictKingHint': 'Kun je geen kleur bekennen, dan móót je de hartenheer afgooien als je hem hebt.',
