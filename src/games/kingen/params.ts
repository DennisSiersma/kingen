 ...
 * Tafel-parameters per spelersaantal: deck-stripping, telling, aantal gevingen.
 */
 ...
 *
 * 4 sp: 52 krt, 13 p.p., 10 gevingen; straffen 13/13/8/8/5/5, troef 4x13 (som 0).
 * 3 sp: 51 krt (zonder ♠2), 17 p.p., 9 gevingen; straffen 17/13/8/4 (1 per dame)/4/5, troef 3x17 (som 0).
 * 5 sp: 50 krt (zonder ♠2 en ♣2), 10 p.p., 11 gevingen; straffen 10/13/8/8/5/6 (7e+10e elk 3), troef 5x10 (som 0).
 *
