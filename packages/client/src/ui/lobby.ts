...
// `counts` = de kiesbare spelersaantallen per spel (= [min..max] uit de registry).
const SPELLEN: { id: string; naam: string; counts: number[] }[] = [
  { id: 'kingen', naam: 'Kingen', counts: [3, 4, 5] },
  { id: 'hartenjagen', naam: 'Hartenjagen', counts: [4] },
  { id: 'hearts', naam: 'Hearts', counts: [4] },
  { id: 'klaverjassen', naam: 'Klaverjassen', counts: [4] },
  { id: 'klaverjas-amsterdams', naam: 'Klaverjassen (Amsterdams)', counts: [4] },
  { id: 'rikken', naam: 'Rikken', counts: [4] },
  { id: 'toepen', naam: 'Toepen', counts: [2, 3, 4, 5, 6, 7, 8] },
  { id: 'mexen', naam: 'Mexen', counts: [4, 5, 6, 7, 8] },
  { id: 'qwixx', naam: 'Qwixx', counts: [2, 3, 4, 5] },
