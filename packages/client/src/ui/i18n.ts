...
const nl = {
  ...
  'qwixx.roll': '🎲 Gooi de dobbelstenen',
  'qwixx.pass': 'Niets kruisen',
  'qwixx.penalty': 'Straf:',
  'qwixx.yourTurn': 'Jouw beurt — gooi de zes stenen',
  'qwixx.whiteHint': 'Witte som {sum}: kruis ’m in één rij (of sla over)',
  'qwixx.colorHint': 'Gekleurde actie: kruis wit + een kleur (of sla over)',
  'fritzen.yourTurn': 'Jouw beurt — gooi de zes stenen',
  'fritzen.roll': '🎲 Gooi de stenen',
  'fritzen.hint': 'Doel: 30+ of 10− ogen. Nu: {total}. Klik stenen om vast te houden.',
  'fritzen.reroll': '🎲 Gooi opnieuw',
  'fritzen.stop': 'Stop (vastleggen)',
  'fritzen.holdFirst': 'Houd eerst minstens één steen vast om opnieuw te gooien.',
  'catalog.fritzen.title': 'Fritzen',
  'catalog.fritzen.desc': 'Dobbelspel met zes stenen: mik op 30 ogen of méér, óf op 10 of minder — alles ertussenin is mis. Per beurt gooi je maximaal vijf keer en leg je telkens minstens één steen vast; de rest gooi je opnieuw. Hoogste totaal over de rondes wint.',
  'variant.fritzen.standaard': 'Zes stenen, doel ≥30 of ≤10 ogen, max. 5 worpen per beurt (telkens ≥1 vastleggen). Punten naar hoe ver in de veilige zone; 3 rondes. 2–8 spelers.',
  'yahtzee.yourTurn': 'Jouw beurt — gooi de vijf stenen',
  'yahtzee.roll': '🎲 Gooi de stenen',
  'yahtzee.reroll': '🎲 Gooi opnieuw',
  'yahtzee.hint': 'Klik stenen om vast te houden, of kies een vak op je scorekaart.',
  'yahtzee.unholdFirst': 'Deselecteer een steen om opnieuw te gooien, of kies een vak.',
  'yahtzee.upper': 'Boven: {sum}/{need}',
  'yahtzee.total': 'Totaal: {total}',
  'yahtzee.cat.ones': 'Enen',
  'yahtzee.cat.twos': 'Tweeën',
  'yahtzee.cat.threes': 'Drieën',
  'yahtzee.cat.fours': 'Vieren',
  'yahtzee.cat.fives': 'Vijven',
  'yahtzee.cat.sixes': 'Zessen',
  'yahtzee.cat.threeKind': 'Drie gelijk',
  'yahtzee.cat.fourKind': 'Vier gelijk',
  'yahtzee.cat.fullHouse': 'Full house',
  'yahtzee.cat.smallStraight': 'Kleine straat',
  'yahtzee.cat.largeStraight': 'Grote straat',
  'yahtzee.cat.yahtzee': 'Yahtzee',
  'yahtzee.cat.chance': 'Chance',
  'catalog.yahtzee.title': 'Yahtzee',
  'catalog.yahtzee.desc': 'De klassieker met vijf stenen en een scorekaart van dertien categorieën. Per beurt gooi je tot drie keer en houd je vrij stenen vast; daarna leg je de worp vast in één nog open vak (mag een 0). Vol je de bovensectie ruim, dan volgt een bonus van 35; elke extra Yahtzee levert 100 punten. Wie alle dertien vakken het slimst vult, wint.',
  'variant.yahtzee.standaard': 'Vijf stenen, 13 categorieën, max. 3 worpen per beurt. Bovenbonus +35 bij ≥63; Yahtzee = 50 en elke extra +100 (met jokerregels). 1–8 spelers.',
  'tienduizend.yourTurn': 'Jouw beurt — gooi de zes stenen',
  'tienduizend.roll': '🎲 Gooi de stenen',
  'tienduizend.rollAgain': '🎲 Gooi door',
  'tienduizend.bank': '💰 Bank',
  'tienduizend.status': 'Pot deze beurt: {pot} · Totaal: {total}',
  'tienduizend.selectScoring': 'Selecteer scorende stenen (1 = 100, 5 = 50, drie gelijk, straat, drie paren…).',
  'tienduizend.selScore': 'Selectie: +{score} → pot wordt {potNa}. Gooi door of bank.',
  'tienduizend.notIn': 'Selectie +{score}, maar je moet eerst {need} in één beurt scoren om binnen te komen.',
  'catalog.tienduizend.title': 'Tienduizend',
  'catalog.tienduizend.desc': 'Klassiek waagspel met zes dobbelstenen. Gooi, leg minstens één scorende steen apart (een 1 = 100, een 5 = 50, drie gelijk = honderdtallen, straat en drie paren = 1500) en kies: pot vastzetten of doorgooien voor méér. Levert een worp niets op, dan ben je álle beurt-punten kwijt. Leg je alle zes apart, dan mag je opnieuw met zes. Eerst binnen via 350, eerste naar 10.000 wint.',
  'variant.tienduizend.standaard': 'Zes stenen, push-your-luck. Verdubbeling bij vier/vijf/zes gelijk, straat & drie paren = 1500. Openingsdrempel 350; eerste naar 10.000 wint (iedereen nog één beurt). 1–8 spelers.',
  'regenwormen.yourTurn': 'Jouw beurt — gooi de acht stenen',
  'regenwormen.roll': '🎲 Gooi',
  'regenwormen.rollAgain': '🎲 Gooi door',
  'regenwormen.pickValue': 'Kies welke ogen je apart legt (🐛 = worm, telt als 5).',
  'regenwormen.status': 'Som: {sum} · Worm: {worm}',
  'regenwormen.canTake': 'Klik een opgelichte tegel om hem te pakken (of gooi door).',
  'regenwormen.needWorm': 'Je hebt nog geen worm — leg er één vast om te kunnen pakken.',
  'regenwormen.tooLow': 'Som onder 21 — gooi door.',
  'regenwormen.rollOn': 'Geen pakbare tegel — gooi door.',
  'regenwormen.steal': 'Stelen:',
  'catalog.regenwormen.title': 'Regenwormen',
  'catalog.regenwormen.desc': 'Waagspel met acht stenen (ogen 1–5 + een worm die 5 telt) en tegels 21–36 vol wormen. Per worp leg je álle stenen van één nieuwe waarde apart en kies je: doorgooien of stoppen. Stoppen mag met minstens één worm en een som vanaf 21; je pakt de tegel gelijk aan je som (of de hoogste die lager is) — of je steelt de boventegel van een ander met exact die som. Mislukt je worp, dan lever je je toptegel in én verdwijnt de hoogste tegel. Meeste wormen wint.',
  'variant.regenwormen.standaard': 'Acht stenen (worm = 5), tegels 21–36 (1–4 wormen). Set-aside per waarde, minimaal 21 + een worm om te pakken; stelen op exacte som. Eindigt als het midden leeg is. 2–7 spelers.',
  ...
  'variant.mexen.eenworp': 'Canonieke Mäxchen-regel: precies één verdekte worp per beurt, daarna aankondigen — geen herworpen, dus meer bluffen.',
  'catalog.variant.mexen3': 'Standaard (3 worpen)',
  'catalog.variant.mexen1': 'Eén worp (klassiek)',
  'catalog.qwixx.title': 'Qwixx',
  'catalog.qwixx.desc': 'Snel dobbelspel met een scorebord van vier kleurrijen. Bij elke worp mag iederéén de witte som kruisen; de actieve speler combineert daarnaast een witte met een gekleurde steen. Kruis strikt van links naar rechts, vergrendel rijen en verzamel zo veel mogelijk kruisjes. Kruis je niets, dan kost dat een strafvak.',
  'variant.qwixx.standaard': 'Twee witte + vier gekleurde stenen, scorebord met vier rijen (rood/geel 2→12, groen/blauw 12→2). Eindigt bij 2 vergrendelde kleuren of 4 strafvakken. 2–5 spelers.',
...
const en: Record<TranslationKey, string> = {
  ...
  'qwixx.roll': '🎲 Roll the dice',
  'qwixx.pass': 'Mark nothing',
  'qwixx.penalty': 'Penalty:',
  'qwixx.yourTurn': 'Your turn — roll the six dice',
  'qwixx.whiteHint': 'White sum {sum}: cross it in one row (or skip)',
  'qwixx.colorHint': 'Coloured action: cross white + a colour (or skip)',
  'fritzen.yourTurn': 'Your turn — roll the six dice',
  'fritzen.roll': '🎲 Roll the dice',
  'fritzen.hint': 'Goal: 30+ or 10− pips. Now: {total}. Click dice to hold.',
  'fritzen.reroll': '🎲 Roll again',
  'fritzen.stop': 'Stop (lock in)',
  'fritzen.holdFirst': 'Hold at least one die first to roll again.',
  'catalog.fritzen.title': 'Fritzen',
  'catalog.fritzen.desc': 'A six-dice game: aim for 30 pips or more, or 10 or fewer — anything in between is a miss. Each turn you roll up to five times, setting aside at least one die each time and re-rolling the rest. Highest total over the rounds wins.',
  'variant.fritzen.standaard': 'Six dice, goal ≥30 or ≤10 pips, max 5 rolls per turn (set aside ≥1 each time). Points by how far into the safe zone; 3 rounds. 2–8 players.',
  'yahtzee.yourTurn': 'Your turn — roll the five dice',
  'yahtzee.roll': '🎲 Roll the dice',
  'yahtzee.reroll': '🎲 Roll again',
  'yahtzee.hint': 'Click dice to hold, or pick a box on your score card.',
  'yahtzee.unholdFirst': 'Release a die to roll again, or pick a box.',
  'yahtzee.upper': 'Upper: {sum}/{need}',
  'yahtzee.total': 'Total: {total}',
  'yahtzee.cat.ones': 'Ones',
  'yahtzee.cat.twos': 'Twos',
  'yahtzee.cat.threes': 'Threes',
  'yahtzee.cat.fours': 'Fours',
  'yahtzee.cat.fives': 'Fives',
  'yahtzee.cat.sixes': 'Sixes',
  'yahtzee.cat.threeKind': 'Three of a kind',
  'yahtzee.cat.fourKind': 'Four of a kind',
  'yahtzee.cat.fullHouse': 'Full house',
  'yahtzee.cat.smallStraight': 'Small straight',
  'yahtzee.cat.largeStraight': 'Large straight',
  'yahtzee.cat.yahtzee': 'Yahtzee',
  'yahtzee.cat.chance': 'Chance',
  'catalog.yahtzee.title': 'Yahtzee',
  'catalog.yahtzee.desc': 'The classic five-dice game with a score card of thirteen categories. Each turn you roll up to three times, freely holding dice; then you lock the roll into one open box (a 0 is allowed). Fill the upper section well for a 35-point bonus; every extra Yahtzee is worth 100. Whoever fills all thirteen boxes most cleverly wins.',
  'variant.yahtzee.standaard': 'Five dice, 13 categories, max 3 rolls per turn. Upper bonus +35 at ≥63; Yahtzee = 50 and every extra +100 (with joker rules). 1–8 players.',
  'tienduizend.yourTurn': 'Your turn — roll the six dice',
  'tienduizend.roll': '🎲 Roll the dice',
  'tienduizend.rollAgain': '🎲 Roll on',
  'tienduizend.bank': '💰 Bank',
  'tienduizend.status': 'Pot this turn: {pot} · Total: {total}',
  'tienduizend.selectScoring': 'Select scoring dice (1 = 100, 5 = 50, three of a kind, straight, three pairs…).',
  'tienduizend.selScore': 'Selection: +{score} → pot becomes {potNa}. Roll on or bank.',
  'tienduizend.notIn': 'Selection +{score}, but you must first score {need} in one turn to get on the board.',
  'catalog.tienduizend.title': 'Ten Thousand',
  'catalog.tienduizend.desc': 'A classic press-your-luck game with six dice. Roll, set aside at least one scoring die (a 1 = 100, a 5 = 50, three of a kind = hundreds, straight and three pairs = 1500) and choose: bank the pot or roll on for more. Score nothing on a roll and you lose every point gathered this turn. Set all six aside and you roll all six again. Get on the board with 350; first to 10,000 wins.',
  'variant.tienduizend.standaard': 'Six dice, press-your-luck. Doubling for four/five/six of a kind, straight & three pairs = 1500. Opening threshold 350; first to 10,000 wins (everyone gets one more turn). 1–8 players.',
  'regenwormen.yourTurn': 'Your turn — roll the eight dice',
  'regenwormen.roll': '🎲 Roll',
  'regenwormen.rollAgain': '🎲 Roll on',
  'regenwormen.pickValue': 'Pick which face to set aside (🐛 = worm, counts as 5).',
  'regenwormen.status': 'Sum: {sum} · Worm: {worm}',
  'regenwormen.canTake': 'Click a highlighted tile to take it (or roll on).',
  'regenwormen.needWorm': 'You have no worm yet — set one aside to be able to take a tile.',
  'regenwormen.tooLow': 'Sum below 21 — roll on.',
  'regenwormen.rollOn': 'No takeable tile — roll on.',
  'regenwormen.steal': 'Steal:',
  'catalog.regenwormen.title': 'Pickomino',
  'catalog.regenwormen.desc': 'A press-your-luck game with eight dice (faces 1–5 plus a worm worth 5) and tiles 21–36 full of worms. Each roll you set aside all dice of one new value and choose: roll on or stop. You may stop with at least one worm and a sum of 21 or more; you take the tile equal to your sum (or the highest lower one) — or steal the top tile of another player with exactly that sum. Fail a roll and you return your top tile while the highest tile is removed. Most worms wins.',
  'variant.regenwormen.standaard': 'Eight dice (worm = 5), tiles 21–36 (1–4 worms). Set aside per value, need 21+ and a worm to take; steal on exact sum. Ends when the centre is empty. 2–7 players.',
  ...
  'variant.mexen.eenworp': 'Canonical Mäxchen rule: exactly one concealed roll per turn, then announce — no re-rolls, so more bluffing.',
  'catalog.variant.mexen3': 'Standard (3 rolls)',
  'catalog.variant.mexen1': 'One roll (classic)',
  'catalog.qwixx.title': 'Qwixx',
  'catalog.qwixx.desc': 'A fast dice game with a sheet of four coloured rows. On every roll anyone may cross off the white sum; the active player also combines a white with a coloured die. Cross strictly left to right, lock rows and gather as many crosses as you can. Mark nothing and you take a penalty.',
  'variant.qwixx.standaard': 'Two white + four coloured dice, a sheet with four rows (red/yellow 2→12, green/blue 12→2). Ends at 2 locked colours or 4 penalties. 2–5 players.',
